...
//		[“”, Vo, 123 Sesame Street, Sunflower, 22904, 4349240311, Virginia, United States, Table Rate, Clicked, Clicked]
		driver.get("https://magento.softwaretestingboard.com/checkout/#shipping"); //debugging
		try {
            Thread.sleep(3000); // 5000 milliseconds = 5 seconds
        } catch (InterruptedException e) {
...
//		[Tunhi, “”, 123 Sesame Street, Sunflower, 22904, 4349240311, Virginia, United States, Table Rate, Clicked, Clicked]
		driver.get("https://magento.softwaretestingboard.com/checkout/#shipping"); //debugging
		try {
            Thread.sleep(3000); // 5000 milliseconds = 5 seconds
        } catch (InterruptedException e) {
...
//		[Tunhi, Vo, “”, Sunflower, 22904, 4349240311, Virginia, United States, Table Rate, Clicked, Clicked]
		driver.get("https://magento.softwaretestingboard.com/checkout/#shipping"); //debugging
		try {
            Thread.sleep(3000); // 5000 milliseconds = 5 seconds
        } catch (InterruptedException e) {
...
//		[Tunhi, Vo, 123 Sesame Street, “”, 22904, 4349240311, Virginia, United States, Table Rate, Clicked, Clicked]
		driver.get("https://magento.softwaretestingboard.com/checkout/#shipping"); //debugging
		try {
            Thread.sleep(3000); // 5000 milliseconds = 5 seconds
        } catch (InterruptedException e) {
		...
		shipping.sendKeys(Keys.TAB, Keys.TAB,
				"Tunhi", Keys.BACK_SPACE, Keys.TAB, 
				"Vo", Keys.TAB,
				Keys.TAB,
				"123 Sesame Street", Keys.TAB, Keys.TAB, Keys.TAB,
				Keys.TAB,
...
//		[Tunhi, Vo, 123 Sesame Street, Sunflower, “”, 4349240311, Virginia, United States, Table Rate, Clicked, Clicked]
		driver.get("https://magento.softwaretestingboard.com/checkout/#shipping"); //debugging
		try {
            Thread.sleep(3000); // 5000 milliseconds = 5 seconds
        } catch (InterruptedException e) {
...
//		[Tunhi, Vo, 123 Sesame Street, Sunflower, 22904, “”, Virginia, United States, Table Rate, Clicked, Clicked]
		driver.get("https://magento.softwaretestingboard.com/checkout/#shipping"); //debugging
		try {
            Thread.sleep(3000); // 5000 milliseconds = 5 seconds
        } catch (InterruptedException e) {
...
//		[Tunhi, Vo, 123 Sesame Street, Sunflower, 22904, 4349240311, “”, United States, Table Rate, Clicked, Clicked]
		driver.get("https://magento.softwaretestingboard.com/checkout/#shipping"); //debugging
		try {
            Thread.sleep(3000); // 5000 milliseconds = 5 seconds
        } catch (InterruptedException e) {
...
//		[Tunhi, Vo, 123 Sesame Street, Sunflower, 22904, 4349240311, Virginia, “”, Table Rate, Clicked, Clicked]
		driver.get("https://magento.softwaretestingboard.com/checkout/#shipping"); //debugging
		try {
            Thread.sleep(3000); // 5000 milliseconds = 5 seconds
        } catch (InterruptedException e) {
...
//		[Tunhi, Vo, 123 Sesame Street, Sunflower, 22904, “”, Virginia, United States, Fixed Rate, Clicked, Clicked]
		driver.get("https://magento.softwaretestingboard.com/checkout/#shipping"); //debugging
		try {
            Thread.sleep(3000); // 5000 milliseconds = 5 seconds
        } catch (InterruptedException e) {
		...
		shipping.sendKeys(Keys.TAB, Keys.TAB, Keys.TAB, Keys.TAB, Keys.TAB, Keys.TAB, Keys.TAB, Keys.UP, Keys.RETURN);
		try {
          Thread.sleep(3000); // 5000 milliseconds = 5 seconds
      } catch (InterruptedException e) {
      }
